    ...
    <div class="min-h-screen flex w-full">
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="fixed inset-y-0 left-0 z-30 w-64 bg-slate-900 text-white transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0 flex flex-col">
            ...
            <div class="overflow-y-auto overflow-x-hidden flex-1 py-6 px-3 space-y-1 custom-scrollbar">
                ...
                <a href="{{ route('admin.messages') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.messages') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.messages') ? '' : 'font-medium' }}">Pesan Konsultasi</span>
                </a>

                {{-- 2.5.1 Antrean Chat --}}
                <a href="{{ route('admin.chat-queue') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.chat-queue') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.chat-queue') ? '' : 'font-medium' }}">Antrean Chat</span>
                </a>

                {{-- 2.6 Broadcast Pesan --}}
                <a href="{{ route('admin.broadcast') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.broadcast') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.broadcast') ? '' : 'font-medium' }}">Broadcast Pesan</span>
                </a>

                {{-- 2.7 Manajemen Relawan --}}
                <a href="{{ route('admin.volunteers') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.volunteers') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.volunteers') ? '' : 'font-medium' }}">Calon Relawan</span>
                </a>

                {{-- 3. Pemetaan Wilayah --}}
                <a href="{{ route('admin.map') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.map') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.map') ? '' : 'font-medium' }}">Pemetaan Wilayah</span>
                </a>

                {{-- 4. Manajemen Konten --}}
                <a href="{{ route('admin.cms.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.cms.*') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.cms.*') ? '' : 'font-medium' }}">Manajemen Konten</span>
                </a>

                {{-- 4.5 Moderasi Komentar --}}
                <a href="{{ route('admin.comments.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.comments.*') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.comments.*') ? '' : 'font-medium' }}">Moderasi Komentar</span>
                </a>
                ...
                @role('super-admin')
                <a href="{{ route('admin.users') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.users') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.users') ? '' : 'font-medium' }}">Pengguna & Akses</span>
                </a>
                @endrole

                {{-- 6. Pengaturan --}}
                <a href="{{ route('admin.settings') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.settings') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.settings') ? '' : 'font-medium' }}">Pengaturan Sistem</span>
                </a>

                {{-- 7. Audit Log --}}
                <a href="{{ route('admin.audit-log') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-colors {{ request()->routeIs('admin.audit-log') ? 'bg-primary-500/10 text-primary-400 font-bold border border-primary-500/20' : 'text-slate-300 hover:text-white hover:bg-slate-800' }}">
                    ...
                    <span class="text-sm {{ request()->routeIs('admin.audit-log') ? '' : 'font-medium' }}">Audit Log</span>
                </a>
            </div>
        ...
        <div class="flex-1 flex flex-col min-w-0 bg-slate-50 relative">
            {{-- Top Navbar --}}
            <header class="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 shrink-0 sticky top-0 z-10">
                <div class="flex items-center gap-4">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <h1 class="font-black text-slate-900 uppercase tracking-tighter text-sm hidden sm:block">Panel Kendali <span class="text-slate-400 font-bold italic">v2.0</span></h1>
                    </div>
                </div>

                <div class="flex items-center gap-6">
                    <a href="{{ route('dashboard') }}" class="group flex items-center gap-2 text-xs font-black text-slate-500 hover:text-primary-600 transition-all uppercase tracking-widest">
                    ...
                    <div class="flex items-center gap-3">
                        <div class="text-right hidden sm:block">
                            <div class="text-xs font-black text-slate-900 leading-none uppercase tracking-tight">{{ Auth::user()->name }}</div>
                            <div class="text-[9px] font-bold text-primary-600 uppercase tracking-widest mt-1">
                                {{ Auth::user()->roles->pluck('name')->first() ?? 'Staff' }}
                            </div>
                        </div>
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-primary-500 to-indigo-600 border-2 border-white shadow-lg shadow-primary-500/20 flex items-center justify-center text-white font-black text-sm uppercase ring-1 ring-slate-100 overflow-hidden">
