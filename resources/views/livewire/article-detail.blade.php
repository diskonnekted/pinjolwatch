<div class="max-w-4xl mx-auto py-12 px-4">
    <div class="mb-8">
        <a href="{{ route('stories') }}" class="inline-flex items-center text-sm font-semibold text-primary-400 hover:text-primary-300 transition-colors">
    ...
    <article class="bg-slate-900 rounded-3xl shadow-[0_4px_20px_rgba(0,0,0,0.3)] border border-slate-800 overflow-hidden">
        @if($article->image_path)
            <div class="relative h-96 w-full">
                ...
                <div class="absolute bottom-8 left-8 right-8">
                    <span class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest bg-primary-600 text-white mb-4 inline-block">
                        {{ $article->type }}
                    </span>
        ...
        @else
            <div class="p-8 md:p-12 border-b border-slate-800 bg-slate-900/50">
                <span class="px-3 py-1 rounded-full text-xs font-bold uppercase tracking-widest bg-primary-900/30 text-primary-400 border border-primary-800 mb-4 inline-block">
                    {{ $article->type }}
                </span>
        ...
        <div class="p-8 md:p-12">
            <div class="flex items-center gap-4 mb-10 pb-8 border-b border-slate-800">
                <div class="w-12 h-12 rounded-full bg-primary-900/30 flex items-center justify-center text-xl font-bold text-primary-400 border border-primary-800">
    ...
    <div class="mt-12 bg-slate-800/50 rounded-3xl p-8 border border-slate-700 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a href="{{ route('stories.create') }}" class="px-8 py-4 bg-primary-600 text-white font-bold rounded-2xl shadow-[0_4px_14px_rgba(13,148,136,0.4)] hover:bg-primary-500 hover:-translate-y-0.5 transition-all active:scale-95 whitespace-nowrap">
            Bagikan Cerita Saya
        </a>
    </div>
</div>
