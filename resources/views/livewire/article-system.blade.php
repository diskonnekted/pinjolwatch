<div class="max-w-5xl mx-auto py-12 px-4">
    <div class="flex flex-col md:flex-row justify-between items-center md:items-end mb-10 gap-6">
        <div>
        ...
        <div class="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
            <div class="relative w-full sm:w-64">
                <input wire:model.live.debounce.300ms="search" type="text" placeholder="Cari artikel..." class="w-full bg-slate-800 border-slate-700 text-slate-200 rounded-xl px-4 py-2.5 text-sm focus:ring-primary-500 focus:border-primary-500">
            ...
            <a href="{{ route('stories.create') }}" class="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-bold rounded-xl shadow-lg hover:bg-primary-700 transition-all active:scale-95 whitespace-nowrap">
        ...
        @forelse($articles as $article)
            <article class="bg-slate-900 rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.3)] border border-slate-800 overflow-hidden flex flex-col hover:shadow-[0_8px_30px_rgba(13,148,136,0.15)] hover:border-primary-900 transition-all duration-300">
                ...
                <div class="p-6 flex-auto">
                    <div class="flex items-center gap-2 mb-4">
                        <span class="px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest 
                            ...
                            @elseif($article->type == 'experience') bg-primary-900/30 text-primary-400 border border-primary-800/50
                ...
                <div class="p-6 pt-0 mt-auto border-t border-slate-800 flex items-center justify-between">
                    ...
                    <a href="{{ route('stories.show', $article->slug) }}" class="text-xs font-bold text-primary-400 hover:text-primary-300 uppercase tracking-widest">Baca Selengkapnya</a>
                </div>
            </article>
        @empty
